...
import { Bug, Scan, Activity, GraduationCap, FileSearch, Wifi, Cloud, Shield, FileCheck, ChevronLeft, ChevronRight } from 'lucide-react';
...
const badges: Badge[] = [
  { icon: Bug, title: 'Vulnerability Assessment', description: 'Web • Mobile • WiFi • Servers', accentFrom: '#3BAFDA', accentTo: '#8C75FF' },
  { icon: Scan, title: 'Penetration Testing', description: 'Black‑Box • Grey‑Box • Red‑Teaming', accentFrom: '#8C75FF', accentTo: '#3BAFDA' },
  { icon: Activity, title: 'SOC & SIEM Setup', description: 'Log Monitoring • Incident Response', accentFrom: '#34D399', accentTo: '#3BAFDA' },
  { icon: GraduationCap, title: 'Security Awareness Training', description: 'Phishing • OSINT • Attack Simulation', accentFrom: '#F59E0B', accentTo: '#8C75FF' },
  { icon: FileSearch, title: 'Forensics & Investigation', description: 'Log Analysis • Recovery • Evidence Report', accentFrom: '#0EA5E9', accentTo: '#22D3EE' },
  { icon: Wifi, title: 'Network Security Monitoring', description: 'Threat Detection • Intrusion Alerts', accentFrom: '#22D3EE', accentTo: '#8C75FF' },
  { icon: Cloud, title: 'Cloud Security', description: 'AWS • Azure • GCP Hardening & IAM', accentFrom: '#8C75FF', accentTo: '#F472B6' },
  { icon: Shield, title: 'Web & API Security Testing', description: 'OWASP Top 10 • API Abuse Prevention', accentFrom: '#3BAFDA', accentTo: '#34D399' },
  { icon: FileCheck, title: 'Compliance & Audit', description: 'ISO • NIST • GDPR • Policy Framework', accentFrom: '#F59E0B', accentTo: '#3BAFDA' },
];

export default function CybersecurityBadgesCarousel() {
