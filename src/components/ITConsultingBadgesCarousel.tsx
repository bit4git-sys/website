...
import { Compass, RefreshCcw, Rocket, Puzzle, BadgeDollarSign, ChevronLeft, ChevronRight } from 'lucide-react';
...
const badges: Badge[] = [
  { icon: Compass, title: 'Technology Strategy', description: 'Roadmaps • Planning • Architecture', accentFrom: '#3BAFDA', accentTo: '#8C75FF' },
  { icon: RefreshCcw, title: 'Digital Transformation', description: 'System upgrades • automation', accentFrom: '#8C75FF', accentTo: '#3BAFDA' },
  { icon: Rocket, title: 'Product Strategy', description: 'MVP planning • release pipeline', accentFrom: '#34D399', accentTo: '#3BAFDA' },
  { icon: Puzzle, title: 'Vendor/Tool Selection', description: 'Cloud • DevTools • stack choices', accentFrom: '#F59E0B', accentTo: '#8C75FF' },
  { icon: BadgeDollarSign, title: 'Cost Optimization', description: 'Reduce infra & dev costs', accentFrom: '#0EA5E9', accentTo: '#22D3EE' },
];

export default function ITConsultingBadgesCarousel() {
