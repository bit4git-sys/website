...
import { Cloud, RefreshCcw, Cog, Shield, HardDrive, Layers, ChevronLeft, ChevronRight } from 'lucide-react';
...
const badges: Badge[] = [
  { icon: Cloud, title: 'Cloud Deployment', description: 'AWS • Azure • GCP setup & management', accentFrom: '#3BAFDA', accentTo: '#8C75FF' },
  { icon: RefreshCcw, title: 'Cloud Migration', description: 'On‑prem → Cloud, data migration', accentFrom: '#8C75FF', accentTo: '#3BAFDA' },
  { icon: Cog, title: 'DevOps Services', description: 'CI/CD pipelines • Docker • Kubernetes', accentFrom: '#34D399', accentTo: '#3BAFDA' },
  { icon: Shield, title: 'Cloud Security', description: 'VPC • IAM • DDoS protection • WAF', accentFrom: '#F59E0B', accentTo: '#8C75FF' },
  { icon: HardDrive, title: 'Data Backup & Storage', description: 'Cloud storage • snapshots • DR', accentFrom: '#0EA5E9', accentTo: '#22D3EE' },
  { icon: Layers, title: 'SaaS App Hosting', description: 'Full multi‑tenant SaaS infrastructure', accentFrom: '#8C75FF', accentTo: '#F472B6' },
];

export default function CloudServiceBadgesCarousel() {
